...
4. You will then be invited to the course organization on GitHub and two separate repositories.
   ...
   - Navigate to the course organization [dat240-2026](https://github.com/dat240-2026) accept the invitation.
   - Navigate to the [assignments](https://github.com/dat240-2026/assignments) repository and accept the invitation.
   - Navigate to your private <https://github.com/dat240-2026/username-labs> repository and accept the invitation.
...
5. Once you have accepted the invitations, you will get your own repository under `dat240-2026`, which is the course's organization on GitHub.
...
2. To join our dat240-2026 Discord server, navigate [here](https://discord.gg/uMhFbBDcNQ).
...
3. Once connected to the server, please register with our bot, `@dat240-help-bot`, by sending it a direct message:
   ...
   Hence, please make sure that you have joined the [`dat240-2026`](https://github.com/dat240-2026) GitHub organization and registered with QuickFeed first.
