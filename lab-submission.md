...
1. Initially, you will get access to two repositories when you have signed up on QuickFeed.
   ...
   The first is the [`assignments`](https://github.com/dat240-2026/assignments) repository, which is where we publish all lab assignments, skeleton code and additional information.
...
2. To get started, decide on a suitable location for your workspace for the course.
   In this guide we will use `$HOME/dat240-2026` as the workspace.
   ...
   ```console
   mkdir $HOME/dat240-2026
   cd $HOME/dat240-2026
   git clone git@github.com:dat240-2026/username-labs assignments
   cd assignments
   git remote add course-assignments git@github.com:dat240-2026/assignments
   ...
   mkdir $HOME/dat240-2026
   cd $HOME/dat240-2026
   git clone https://github.com/dat240-2026/username-labs assignments
   cd assignments
   git remote add course-assignments https://github.com/dat240-2026/assignments
   git pull course-assignments main
   ```
...
7. In summary, these are the typical steps that are necessary to make changes to
   ...
   ```console
   cd $HOME/dat240-2026/assignments/Lab1
   code program.cs
...
1. As time goes by the teaching staff may publish updates to the
   course [assignments](https://github.com/dat240-2026/assignments) repo,
...
We assume you have already created the `dat240-2026` directory on your machine.

```console
cd $HOME/dat240-2026
git clone git@github.com:dat240-2026/groupname.git
cd groupname
git remote add course-assignments git@github.com:dat240-2026/assignments
git pull course-assignments master
```
